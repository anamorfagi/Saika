...
Собирает `anamorf/MODULES.md` — список всех модулей с ПЕРВОЙ строкой их
...
GROUPS = [
    ...
    ("Руки", ["pc_control", "ui_hands", "browser_hands", "file_hands",
              ...
              "dictation", "highlight", "send_gate", "services"]),
