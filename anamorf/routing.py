...
Повод — стыдный. anamorf/vision.py полгода умел look_screen (снять кадр и
...
def plan(user_text: str) -> list:
    ...
    try:
        ...
        from anamorf.llm import skills
    ...
    for cap, hands in HANDS.items():
        ...
        bad.append({
            ...
            "human": ("умение «%s» объявлено, но инструментов %s нет в "
                      ...
                      % (cap, ", ".join(missing))),
            "cure": ("подключить схемы в anamorf/llm/tools.py "
