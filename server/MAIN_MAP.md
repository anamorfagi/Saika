...
Всего строк: **9582**, ручек HTTP: **160**, функций верхнего уровня: **212**.
...
| 6280 | ступени тишины (как idle-анимации персонажа в игре) |
| 6352 | окно браузера простаивает -> сама спрашивает/закрывает |
| 6422 | WebSocket |
| 7790 | внимание: когда фраза адресована Сайке |

## Самые большие куски

Эти пять функций — половина файла. Читать их подряд не надо: ниже оглавление по внутренним заголовкам.

### `ws_endpoint()` — строки 6424–8841 (2417)

- 6485 — ГЛУБИНА ОЧЕРЕДИ СЛУХА
- 6501 — ОЧЕРЕДЬ ГОТОВЫХ ФРАЗ
- 6525 — ЕСЛИ НЕ УСПЕВАЕМ — ЖЕРТВУЕМ АНАЛИЗОМ
- 6569 — КОРОТКИЙ ПУТЬ ДЛЯ СИСТЕМНОГО ЗВУКА
- 6576 — УШИ СЛУШАЮТ И КОМПЬЮТЕР (2026-08-16)
- 6622 — СВОЁ ЭХО НЕ ГОНЯЕМ ЧЕРЕЗ ТЯЖЁЛЫЙ КОНВЕЙЕР (2026-08-15)
- 6642 — «СТОЙ» ОБЯЗАНО РАБОТАТЬ И КОГДА ОНА ГОВОРИТ
- 6669 — ПРЕДОХРАНИТЕЛЬ РЕАЛЬНОГО ВРЕМЕНИ
- 6695 — «БУДЬ ЗДОРОВ»
- 6718 — БИТБОКС-ТРАНСКРИБ
- 6728 — КЛАВИАТУРА — НЕ БИТБОКС
- 6785 — ОТПЕЧАТОК — ТОЛЬКО НА НАСТОЯЩЕЙ РЕЧИ (2026-08-15)
- 6899 — СКОЛЬЗЯЩАЯ НОРМАЛИЗАЦИЯ
- 6943 — ЖИВАЯ ПОДСВЕТКА КАЧЕСТВА
- 6981 — ДОЛЯ ОЗВОНЧЕННОГО (2026-08-16)
- 7078 — ПРОТУХШИЙ КУСОК НЕ РОЖДАЕТ ФРАЗУ
- 7094 — ОПОЗДАТЬ И НАПИСАТЬ ЛУЧШЕ
- 7123 — НАЗЫВАЕМ ВИНОВНИКА ВСЛУХ
- 7157 — ВТОРОЙ ПРОХОД ШУМОДАВА — НА СОБРАННОЙ ФРАЗЕ (2026-08-15)
- 7175 — СМЕНА ГОЛОСА ВНУТРИ ФРАЗЫ (2026-08-15)
- 7206 — ДВЕ ДОРОЖКИ ИЗ ОДНОГО МИКРОФОНА (2026-08-16)
- 7231 — МАСТЕРИНГ ФРАЗЫ ПЕРЕД ДВИЖКОМ (2026-08-16)
- 7251 — АНАЛИЗ — ПО ВЫРОВНЕННОМУ ЗВУКУ ТОЖЕ
- 7287 — МЕТКИ ГОЛОСА
- 7302 — ДЛЯ РАЗВОДА ПО ЛЮДЯМ — ECAPA
- 7355 — СКЛЕЙКА ОБОРВАННОЙ МЫСЛИ (2026-08-16)
- 7373 — СКЛЕЙКА — ПО КАНАЛАМ
- 7386 — ДВА ГОЛОСА ЗА «МЫСЛЬ КОНЧИЛАСЬ»
- 7403 — ФАНТОМ НА КЛАВИАТУРЕ
- 7423 — УДАР — ТА ЖЕ УЛИКА
- 7482 — ЛОГИКА ПРАВИЛЬНОГО НАПИСАНИЯ (2026-08-15)
- 7488 — РАСТЯЖКА
- 7611 — МОДЕЛЬ ВЫКЛЮЧЕНА (2026-07-28)
- 7644 — ОТКАЗ СИЛЬНЕЕ СОГЛАСИЯ
- 7672 — МОЛЧА И ВИДНО
- 7719 — ПРИДЕРЖКА ПЕРЕБИВОК
- 7973 — ШИРОКАЯ ПОЛОСА — НЕ УЛИКА
- 8018 — ТОН БЕЗ ТЕМБРА НОВЫХ ИМЁН НЕ РАЗДАЁТ
- 8036 — ГРУППЫ ПО ТОНУ: КОГДА КАРТА ГОЛОСОВ ЕЩЁ НИКОГО НЕ ЗНАЕТ
- 8084 — ПОРОГ ЗАВИСИТ ОТ ТОГО
- 8221 — НОВЫЙ ЧЕЛОВЕК ЗАВОДИТСЯ ТОЛЬКО С ХОРОШЕГО КУСКА
- 8268 — СЛИЯНИЕ СБЛИЗИВШИХСЯ ГРУПП
- 8361 — «СТОП» ВЫШЕ ВСЕГО ОСТАЛЬНОГО
- 8385 — МЕТКА ГОВОРЯЩЕГО (2026-07-28)
- 8408 — КОРМИМ СКЕЛЕТ ГОЛОСА (2026-08-16)
- 8434 — ПОД МУЗЫКУ ТИХИЙ КУСОК — ПОЧТИ ВСЕГДА ВЫДУМКА
- 8461 — СТЕНОГРАММА
- 8487 — ЭХО ИЗ КОЛОНОК
- 8506 — ОТВЕЧАЮ ТОЛЬКО ВЛАДЕЛЬЦУ
- 8528 — ТИХАЯ ЗАЩИТА — НЕ ЗАЩИТА (2026-08-14)
- 8545 — ЛИДЕР СРАВНЕНИЯ
- 8590 — ТИХИЙ РЕЖИМ
- 8602 — СОЦИАЛЬНЫЙ ТАКТ
- 8611 — СЧИТАЕМ ФРАЗЫ
- 8652 — СЛУХ ЖИВЁТ В СВОЁМ ПОТОКЕ
- 8690 — ЧТО ИМЕННО НЕ УСПЕВАЕТ — В ТОЙ ЖЕ СТРОКЕ
- 8751 — КОРОТКИЕ КУСКИ ДЛЯ НЕПРЕРЫВНОЙ РЕЧИ (2026-07-28)
- 8763 — ЧИСЛА ВЫНЕСЕНЫ В КОНФИГ (2026-08-16)
...
### `_autostart_components()` — строки 8878–9234 (356)

Автопуск слуха/голоса/мозгов при старте (2026-07-20). Каждый компонент

- 8895 — ПОДКЛЮЧИТЬ ВСЁ
- 8909 — БРАУЗЕР ЧЕЛОВЕКА — САМИ
- 8977 — СТРАЖ ПЕТЛИ КРАШЕЙ — ДО ВСЯКОЙ ЗАГРУЗКИ ГОЛОСА (2026-08-14)
- 8992 — РЕВИЗИЯ СВЯЗНОСТИ (2026-08-15)
- 9075 — ПОРЯДОК ЗАПУСКА
- 9124 — ОБЛАКО ТОЖЕ УЧАСТВУЕТ (2026-08-14)
- 9169 — ОБЛАЧНАЯ ПЕРВОЙ — И ЭТО МГНОВЕННО
- 9226 — ЗАСЕЧКА ЗДОРОВОГО ЗАПУСКА (2026-08-14)

### `main()` — строки 9237–9577 (340)

- 9350 — ЗАЩИТА ЖЕЛЕЗА
- 9359 — БЕСХОЗНЫЙ ДВИЖОК ПРИ ТЕСНОЙ ПАМЯТИ ВЫГРУЖАЕМ САМИ
- 9385 — СНАЧАЛА ЛИШНЕЕ
- 9496 — СКОЛЬКО ЖДАТЬ — РЕШАЕТ ПАМЯТЬ О ВКЛАДКЕ (2026-08-15)
